...
- A Story 4.12 está `Ready` e sem implementação. A Story 4.11 e a disposição
  ...
  `GO`.
- Readiness revalidado localmente em `4.12-readiness/2026-09-09-r2`, incluindo
  cardinalidade, seeds/API/callback e thenables malformados aprovados, além da
  ordenação numérica; pareceres atuais e revisão examinada estão na Story 4.12. Este
